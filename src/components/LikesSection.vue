...
<template>
    <div class="flex justify-between py-2">
        <div class="flex space-x-4">
            <svg aria-label="Like" class="text-gray-600 cursor-pointer hover:fill-red-500" color="rgb(245, 245, 245)"
            ...
            <svg aria-label="Comment" class="text-gray-600 cursor-pointer hover:text-gray-400" color="rgb(245, 245, 245)"
            ...
            <svg aria-label="Share Post" class="text-gray-600 cursor-pointer hover:text-gray-400" color="rgb(245, 245, 245)"
                fill="rgb(245, 245, 245)" height="24" role="img" viewBox="0 0 24 24" width="24">
        ...
        <div>
            <svg aria-label="Save" class="text-gray-600 cursor-pointer" color="rgb(245, 245, 245)" fill="rgb(245, 245, 245)"
